...
function Main() {
    return (
        <div className="main">
            <h1 className="supportGuide" id="supportGuideId">Support Guide</h1>
            <p className="LModify">Last Modified: May 22, 2020</p>

            <h2 className="SetUpMeetingRooms">Set up your Microsoft 365 meeting rooms</h2>

            <h3 className="AddMeetingRooms" id="addMeeting">Add meeting rooms in Microsoft 365</h3>
            ...
            <h3 className="connectTo" id="connectToMicrosoft">Connect to Microsoft 365 </h3>
            ...
            <h3 className="connectTo" id="manageSecSett">Manage security settings</h3>
            ...
            <h2 className="setupOffice" id="setupOffice">Setup your office</h2>

            <h3 className="connectTo" style={{marginTop: "0px"}} id="meetOfficees">Meet offices</h3>
            ...
            <h3 className="connectTo" id="campuses">Campuses</h3>
            <p className="toDo">
            ...
            <h3 className="connectTo" id="buildings">Buildings</h3>
            <p className="toDo">
            ...
            <h3 className="connectTo" id="rooms">Rooms</h3>
            <p className="toDo">
            ...
            <h3 className="connectTo" id="roomGroups">Room Groups</h3>
            <p className="toDo">
            ...
            <h2 className="SetUpMeetingRooms" id="setUpMeetingRooms">Digital signage & customizing signage settings</h2>
            ...
            <h3 className="connectTo" id="messagingSlides">Messaging slides</h3>
            <p className="toDo">
            ...
            <h3 className="connectTo" id="signageGropus">Signage Gropus</h3>
            <p className="toDo">
            ...
            <h3 className="connectTo" id="signageSetting">Signage Settings </h3>
            <p className="toDo">
            ...
            <h2 className="SetUpMeetingRooms" id="devLis">Devices & licensing </h2>

            <h3 className="connectTo" id="manageSub">Manage subscription & licensing </h3>
            <p className="toDo">
            ...
            <h3 className="connectTo" id="devices">Devices </h3>
            <p className="toDo">
            ...
            <h2 className="SetUpMeetingRooms" id="meetAppSch">Meet app scheduling</h2>
            ...
            <h3 className="connectTo" id="viewEndMeetings" style={{marginBottom: 16}}>View & End Meetings  </h3>
            ...
            <h2 className="connectTo" id="contactInfo" style={{marginBottom: 16}}>Contact information  </h2>
            <div>
